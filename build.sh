...
mkdir -p dist
cp app/build/outputs/apk/release/app-release.apk dist/IPTVy-1.2-release.apk
...
echo "Built: dist/IPTVy-1.2-release.apk (also copied to dist/IPTVy.apk and web/iptvy.apk)"
